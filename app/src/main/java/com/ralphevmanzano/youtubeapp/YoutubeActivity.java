...
public class YoutubeActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    static final String GOOGLE_API_KEY = "AIzaSyB4dS40AufeFsy79jv_bR0WwRPOqIFtv_s";
    static final String YOUTUBE_VIDEO_ID = "XuaC3dXayAs";
    static final String YOUTUBE_PLAYLIST = "PLzPlx_hy42tQ-gqB-n46qNLAkUbWlTd7C";
